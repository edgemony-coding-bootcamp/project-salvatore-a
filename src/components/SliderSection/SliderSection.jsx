    ...
    <div className={styles.SliderSection}>
      ...
      {moviesData.length ? (
        <div className={styles.SliderSection__Slider}>
          <AliceCarousel
            ...
            disableButtonsControls={
              window.innerWidth > 770 ? false : screenWidth
            }
            ...
            renderPrevButton={() => {
              return (
                <span className={styles.SliderSection__Left}>
                  {" "}
            ...
            renderNextButton={() => {
              return (
                <span className={styles.SliderSection__Right}>
                  {" "}
        ...
        <div className={styles.SliderSection__ListEmpty}>
          <BsFillEmojiDizzyFill /> Whoooops, non c'è niente qui!!
        </div>
      )}
    </div>
  );
